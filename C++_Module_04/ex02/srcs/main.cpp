...
/*   Updated: 2024/03/04 13:49:35 by galambey         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int ft_error( const AAnimal *a, const AAnimal *b , Dog *c, Cat *d ) {
...
int ft_error( AAnimal **AnimalTab ) {
...
int main() {
	...
	{
		AAnimal **AnimalTab = NULL;
		try {
			AnimalTab = new AAnimal*[10];
			if (!AnimalTab)
				return (1);
			for (int i = 0; i < 10; i++)
				AnimalTab[i] = NULL;
