...
/*   Updated: 2024/03/04 12:44:36 by galambey         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Animal {
	...
	public :
		...
		*/
		...
		virtual void setBrain( std::string idea ); // To test deep copy of Doc and Cat copy constructor
		virtual void printBrain( void ) const ; // To test deep copy of Doc and Cat copy constructor
} ;
